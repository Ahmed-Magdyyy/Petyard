...
import substitutionRoutes from "../domains/substitution/substitution.routes.js";
...
export function mountRoutes(app) {
  ...
  app.use("/api/v1/orders", substitutionRoutes);
  ...
  app.use("/api/v1/app-versions", appVersionRoutes);
}
