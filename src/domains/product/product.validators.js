...
export const updateProductValidator = [
  ...
  body("warehouseStocks.*.expectedRevision")
    .optional()
    .isInt({ min: 0 })
    .withMessage(
      "warehouseStocks.*.expectedRevision must be a non-negative integer",
    )
    .toInt(),
  ...
  body("variants.*.warehouseStocks.*.expectedRevision")
    .optional()
    .isInt({ min: 0 })
    .withMessage(
...
export const adminSearchProductsQueryValidator = [
  query("q")
    .notEmpty()
    .withMessage("q is required")
    .isString()
