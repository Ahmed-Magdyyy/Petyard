...
/**
 * Build a regex pattern that treats common separators and punctuation as an
 * optional run between characters.
 *
 ...
 * "cats white" matches "Cat's White", and "canine dry" matches "Canine - Dry".
 *
 * Steps:
 *  1. Strip separators/punctuation from the query.
 *  2. Escape each remaining character for regex safety.
 *  3. Join them with a separator class so any separator run is optional.
 */
